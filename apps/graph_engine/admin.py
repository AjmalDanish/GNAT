...
This module configures Django admin interface for graph engine models.
...
class CityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("country", "city_name")}),
        ("Geographic Information", {"fields": ("latitude", "longitude")}),
        ("Demographics", {"fields": ("population", "timezone")}),
        (
            "Metadata",
            {
                "fields": (
